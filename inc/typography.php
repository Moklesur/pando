...
function themetim_typography_color($color) {
    ...
    $color .= ".footer-main .footer-social a:hover,.footer-main ,.footer-main a,.footer-main p,.footer-main h3{ color: ". esc_attr($footer_text_color) .";} ";

    /*
     * Default Button
     */
    $btn_default_bg = get_theme_mod( 'btn_default_bg', '#000' );
    ...
    $btn_default_bg_hover = get_theme_mod( 'btn_default_bg_hover', '#fec826' );
    $btn_default_text_hover = get_theme_mod( 'btn_default_text_hover', '#fff' );
    $btn_default_border_hover = get_theme_mod( 'btn_default_border_hover', '#fec826' );
     ...
     * Primary Button
     */
    $btn_primary_bg = get_theme_mod( 'btn_primary_bg', '#fec826' );
    $btn_primary_text = get_theme_mod( 'btn_primary_text', '#fff' );
    $btn_primary_border = get_theme_mod( 'btn_primary_border', '#fec826' );
